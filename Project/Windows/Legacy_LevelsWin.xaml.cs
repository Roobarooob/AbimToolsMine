...
//Этот код определяет WPF-окно и внешнюю команду для Autodesk Revit.
//Окно позволяет пользователям проверять уровни различных элементов в проекте
//Revit и задавать параметр на основе этих уровней. Команда собирает такие элементы,
//как экземпляры семейств, стены, перекрытия, потолки, трубы, воздуховоды и кабельные
//лотки, проверяет их уровни относительно уровней проекта и обновляет параметр
//«ПРО_Этаж» соответствующим именем уровня или сообщением об ошибке, если уровни не совпадают.
//Код также включает обработку ошибок для случаев,
//когда у некоторых элементов могут отсутствовать необходимые параметры.
